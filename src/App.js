...
class App extends Component {
  ...
  getFilterListOf = () => {
    ...
    const allFilterList = projectsList.filter(
  ...
  render() {
    ...
    const allFilterList = this.getFilterListOf()
    return (
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              isUnderLine={activeTabId === tabDetails.tabId}
            />
          ))}
        </ul>

        <ul className="project-list-container">
          {allFilterList.map(projectDetails => (
            <ProjectItem
